...
export function component_choice_multiple_generic(
    parent, view, choices, on_choose, on_remove, next_screen) {
    ...
    select.focus();
    element_button_standard(parent, 'Remove', () => {
        on_remove(select.value);
        view.refresh();
    });
    return select;
}
