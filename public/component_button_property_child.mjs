...
export function component_button_property_child(parent, view, title, prefix, stored, property_name, field_infos, component_on_open) {
    component_button_view(
        ...
        function on_tile_choose(parent, view) {
            component_new_open_local_storage_property(
                parent, view, prefix, stored, property_name, field_infos, component_on_open, !component_on_open
            );
        }
    );
}
